...
resource createForwardDNSZone 'Microsoft.Compute/virtualMachines/runCommands@2023-09-01' = {
  ...
  properties: {
    source: {
      script: 'Add-DnsServerPrimaryZone -Name "logcorner.local" -ZoneFile "logcorner.local.dns"'
    }
  }
}
...
resource createDNSRecords 'Microsoft.Compute/virtualMachines/runCommands@2023-09-01' = {
  ...
  properties: {
    source: {
      script: 'Add-DnsServerResourceRecordA -Name "onpremhost" -ZoneName "logcorner.local" -IPv4Address "10.13.37.10"'
    }
  }
}
